export const themes = {
  ...
  export const map_variable_lookup = {
    ...
    'classification': {'geography' : 'ttwa', 'full_name' : 'gva', 'avg': 450, 'scale': [-0.5,0.5,1.5,2.5,3.5,4.5], 'scale_string': ['Minor', 'Small', 'Medium', 'Large', 'Major'], 'scale_colours': colors.seq_5},
